    ...
    /*
        Element ID's which we can access to display 
        a new part when user makes a wrong guess.
    */
    ...
    /*
        Get necessary elements from DOM to display 
        a graphical UI & update game status to end user.
    */
    ...
    /*
        Store other information, update game status &
        keep track of player's moves, properties, etc.
    */
    let WORDS = [];
    let LETTER_ID = '';
    let WORD_TO_GUESS = '';
    ...
    async function GENERATE_WORD(){
        if(GAME_ON){
            ...
            if(HINTS_LEFT >= 3){
                ...
                DEFINITION_BUTTON.textContent = 'GET DEFINITION OF THE WORD (COST 3 HINTS & NOT 100% SURE)'
